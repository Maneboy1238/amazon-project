...
products.forEach(
 ...
 generateAmazonHtml += `<div class="product-container">
...
document.querySelector('.js-all-products-container').innerHTML = generateAmazonHtml;
  ...
  btn => {
    btn.addEventListener('click',
      () => {
        ...
        const jsNumSelect = document.querySelectorAll(`.js-product-num-select-${productId}`);
